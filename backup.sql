...
ALTER TABLE orders_order OWNER TO postgres;
...
ALTER TABLE orders_order_items OWNER TO postgres;

--
-- Name: orders_order_items_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE orders_order_items_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE orders_order_items_id_seq OWNER TO postgres;

--
-- Name: orders_order_items_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE orders_order_items_id_seq OWNED BY orders_order_items.id;
...
ALTER TABLE ONLY orders_order_items ALTER COLUMN id SET DEFAULT nextval('orders_order_items_id_seq'::regclass);
...
76	Can add order	37	add_order
77	Can change order	37	change_order
78	Can delete order	37	delete_order
\.
...
1	pbkdf2_sha256$36000$vb4Vwra3pKgn$5ElrN5OATxoQ2rSE70ZJgzMvm3R1LA+9fFpr2FWm2+4=	2018-11-27 09:12:04.34628+00	t	admin			sino@g.ucla.edu	t	t	2018-11-10 00:05:14.372589+00
38	pbkdf2_sha256$36000$QxVrOYkc8xQU$hTYIjVzz65NfnDNbnjmMU0r/r72tjyhpu/2GyP5aDPM=	\N	f	alexlongerbeam	Alex	Longerbeam	alexlongerbeam@yahoo.com	f	t	2018-11-27 09:18:37+00
\.
...
COPY categories_orderplace (id, place_name, address, lat, lng) FROM stdin;
6	Hilltop Store	330 De Neve Dr, Los Angeles, CA 90024	34.0724470	-118.4508870
5	Bruin Cafe	350 De Neve Dr, Los Angeles, CA 90095	34.0726380	-118.4504120
4	The Study at Hedrick	250 De Neve Dr, Los Angeles, CA 90024	34.0730420	-118.4521780
1	Rendezvous	330 De Neve Dr, Los Angeles, CA 90024	34.0726060	-118.4517490
3	Cafe 1919	330 De Neve Dr, Los Angeles, CA 90095	34.0727620	-118.4508480
2	De Neve Late Night	351 Charles E Young Drive West, Los Angeles, CA 90024	34.0704870	-118.4502580
\.
...
37	2018-11-27 09:15:40.677899+00	6	Hilltop Store	2	[{"changed": {"fields": ["lat", "lng"]}}]	36	1
38	2018-11-27 09:16:12.187928+00	5	Bruin Cafe	2	[{"changed": {"fields": ["lat", "lng"]}}]	36	1
39	2018-11-27 09:16:46.892008+00	4	The Study at Hedrick	2	[{"changed": {"fields": ["lat", "lng"]}}]	36	1
40	2018-11-27 09:17:20.177356+00	1	Rendezvous	2	[{"changed": {"fields": ["lat", "lng"]}}]	36	1
41	2018-11-27 09:17:53.531568+00	3	Cafe 1919	2	[{"changed": {"fields": ["lat", "lng"]}}]	36	1
42	2018-11-27 09:18:22.753237+00	2	De Neve Late Night	2	[{"changed": {"fields": ["lat", "lng"]}}]	36	1
43	2018-11-27 09:18:37.447341+00	38	alexlongerbeam	1	[{"added": {}}]	4	1
44	2018-11-27 09:18:49.189871+00	38	alexlongerbeam	2	[{"changed": {"fields": ["first_name", "last_name", "email"]}}]	4	1
45	2018-11-27 09:19:00.752192+00	5	alexlongerbeam	1	[{"added": {}}]	12	1
\.
...
38	categories	0004_auto_20181127_0443	2018-11-27 09:11:54.405441+00
39	orders	0001_initial	2018-11-27 09:11:54.453275+00
40	orders	0002_auto_20181127_0456	2018-11-27 09:11:54.522343+00
\.
...
gjhtsyno0hyo3cvjfroetjp7mnqb407x	MzI4YTdhZGMwMDkyMTNjMzFiMjEwYzhjZjY0MjBiYTFmMmE1MWExYTp7Il9hdXRoX3VzZXJfaWQiOiIxIiwiX2F1dGhfdXNlcl9iYWNrZW5kIjoiZGphbmdvLmNvbnRyaWIuYXV0aC5iYWNrZW5kcy5Nb2RlbEJhY2tlbmQiLCJfYXV0aF91c2VyX2hhc2giOiIyM2VhZDVlZWQ5MzY2ZTUzODZlYjkxMjMxMzY5ODVhOGUwMTlkMmRlIn0=	2018-12-11 09:12:04.348837+00
\.
...
COPY orders_order (id, delivery_address, delivery_fee, order_status, courier_rating, order_time, completion_time, courier_id, customer_id) FROM stdin;
1	610 Levering Ave	0.00	OP	\N	2018-11-27 09:21:54.225299+00	\N	\N	5
\.
...
COPY orders_order_items (id, order_id, orderitem_id) FROM stdin;
1	1	43
\.
...
SELECT pg_catalog.setval('auth_user_id_seq', 38, true);
...
SELECT pg_catalog.setval('orders_order_items_id_seq', 1, true);
...
SELECT pg_catalog.setval('profiles_profile_id_seq', 5, true);
...
ALTER TABLE ONLY orders_order_items
...
--
-- Name: orders_order_courier_id_80f94e0c; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX orders_order_courier_id_80f94e0c ON orders_order USING btree (courier_id);
...
CREATE INDEX orders_order_items_order_id_ffafb841 ON orders_order_items USING btree (order_id);
...
CREATE INDEX orders_order_items_orderitem_id_97c0b6c4 ON orders_order_items USING btree (orderitem_id);
...
--
-- Name: orders_order orders_order_courier_id_80f94e0c_fk_profiles_profile_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY orders_order
    ADD CONSTRAINT orders_order_courier_id_80f94e0c_fk_profiles_profile_id FOREIGN KEY (courier_id) REFERENCES profiles_profile(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: orders_order orders_order_customer_id_0b76f6a4_fk_profiles_profile_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY orders_order
    ADD CONSTRAINT orders_order_customer_id_0b76f6a4_fk_profiles_profile_id FOREIGN KEY (customer_id) REFERENCES profiles_profile(id) DEFERRABLE INITIALLY DEFERRED;
...
ALTER TABLE ONLY orders_order_items
    ADD CONSTRAINT orders_order_items_order_id_ffafb841_fk_orders_order_id FOREIGN KEY (order_id) REFERENCES orders_order(id) DEFERRABLE INITIALLY DEFERRED;


--
-- Name: orders_order_items orders_order_items_orderitem_id_97c0b6c4_fk_categorie; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY orders_order_items
    ADD CONSTRAINT orders_order_items_orderitem_id_97c0b6c4_fk_categorie FOREIGN KEY (orderitem_id) REFERENCES categories_orderitem(id) DEFERRABLE INITIALLY DEFERRED;
